...
public class CmdIpBansCreateHandler extends CommandHandlerAsync {
  ...
  public CmdIpBansCreateHandler(CommandSender sender, ProcessedCommandArguments args, SpigotPluginConfig config) {
    super(sender, args);
    this.config = config;
  }
