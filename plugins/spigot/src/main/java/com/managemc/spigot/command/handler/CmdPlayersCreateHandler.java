...
public class CmdPlayersCreateHandler extends CommandHandlerAsync {

  public static final String SUCCESS_MSG = ChatColor.GREEN + "Successfully added %s to the ManageMC database";

  private final SpigotPluginConfig config;

  public CmdPlayersCreateHandler(CommandSender sender, ProcessedCommandArguments args, SpigotPluginConfig config) {
    super(sender, args);
    this.config = config;
  }
