...
public class CmdPunishmentsGetHandler extends CommandHandlerAsync {
  ...
  public CmdPunishmentsGetHandler(CommandSender sender, ProcessedCommandArguments args, SpigotPluginConfig config) {
    super(sender, args);
    this.config = config;
  }
