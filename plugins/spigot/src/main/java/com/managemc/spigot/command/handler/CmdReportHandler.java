...
public class CmdReportHandler extends CommandHandlerAsync {
  ...
  public CmdReportHandler(CommandSender sender, ProcessedCommandArguments args, SpigotPluginConfig config) {
    super(sender, args);
    this.config = config;
  }
