...
public abstract class BanOrMuteSuccessFormatter extends ChatFormatterBase<BanOrMute> {

  private final ServerGroupsData serverGroups;

  public BanOrMuteSuccessFormatter(BanOrMute formattable, ServerGroupsData serverGroups) {
    super(formattable);
  ...
  public String format() {
    ...
    return new PluginMessageFormatter()
        .header("Successfully " + getPastTenseVerb() + " " + obj.getOffender().getUsername())
        .indent()
