...
public class CmdPlayersCreateTest extends TestBase {

  public static final String SUCCESS_MESSAGE = String.format(CmdPlayersCreateHandler.SUCCESS_MSG, PHYLLIS_USERNAME);
